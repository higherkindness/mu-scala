...
final case class AvroUnion8[T1, T2, T3, T4, T5, T6, T7, T8](value: T1 | T2 | T3 | T4 | T5 | T6 | T7 | T8)
    ...
    def decode(schema: Schema): Any => AvroUnion7[T1, T2, T3, T4, T5, T6, T7] = {
      ...
      { value =>
        if (canDecode[T1](schema1)(value)) {
          ...
          throw decodingException(value, schema1, schema2, schema3, schema4, schema5, schema6, schema7)
        }
      }
    }
    ...
    def decode(schema: Schema): Any => AvroUnion8[T1, T2, T3, T4, T5, T6, T7, T8] = {
      ...
      { value =>
        if (canDecode[T1](schema1)(value)) {
          ...
          throw decodingException(value, schema1, schema2, schema3, schema4, schema5, schema6, schema7, schema8)
        }
      }
    }

...
class IdlGenTests extends RpcBaseTestSuite {
  ...
  val greeterRpcs = RpcDefinitions(
    ...
    Seq(RpcService("Greeter", Seq(
      RpcRequest( "sayHelloAvro"       , t"HelloRequest", t"HelloResponse", None),
      RpcRequest("sayHelloAvro"        , t"HelloRequest", t"HelloResponse", None),
      RpcRequest("sayHelloProto"       , t"HelloRequest", t"HelloResponse", None),
      RpcRequest( "sayNothingAvro"     , t"Empty.type"  , t"Empty.type"   , None),
      RpcRequest("sayNothingAvro"      , t"Empty.type"  , t"Empty.type"   , None),
      RpcRequest("sayNothingProto"     , t"Empty.type"  , t"Empty.type"   , None),
      RpcRequest( "lotsOfRepliesAvro"  , t"HelloRequest", t"HelloResponse", Some(ResponseStreaming)),
      RpcRequest("lotsOfRepliesAvro"   , t"HelloRequest", t"HelloResponse", Some(ResponseStreaming)),
      RpcRequest("lotsOfRepliesProto"  , t"HelloRequest", t"HelloResponse", Some(ResponseStreaming)),
      RpcRequest( "lotsOfGreetingsAvro", t"HelloRequest", t"HelloResponse", Some(RequestStreaming)),
      RpcRequest("lotsOfGreetingsAvro" , t"HelloRequest", t"HelloResponse", Some(RequestStreaming)),
      RpcRequest("lotsOfGreetingsProto", t"HelloRequest", t"HelloResponse", Some(RequestStreaming)),
      RpcRequest( "bidiHelloAvro"      , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming)),
      RpcRequest("bidiHelloAvro"       , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming)),
      RpcRequest("bidiHelloProto"      , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming)),
      RpcRequest( "bidiHelloFs2Avro"   , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming)),
      RpcRequest("bidiHelloFs2Avro"    , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming)),
      RpcRequest("bidiHelloFs2Proto"   , t"HelloRequest", t"HelloResponse", Some(BidirectionalStreaming))
    )))
  )

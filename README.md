...
libraryDependencies += "io.frees" %% "frees-rpc-server"            % "0.13.2"

// required for a protocol definition:
libraryDependencies += "io.frees" %% "frees-rpc-client-core"       % "0.13.2"

// required for the use of the derived RPC Client/s, using either Netty or OkHttp as transport layer:
libraryDependencies += "io.frees" %% "frees-rpc-client-netty"      % "0.13.2"
// or:
libraryDependencies += "io.frees" %% "frees-rpc-client-okhttp"     % "0.13.2"

// optional - for both server and client configuration.
libraryDependencies += "io.frees" %% "frees-rpc-config"            % "0.13.2"

// optional - for both server and client metrics reporting, using Prometheus.
libraryDependencies += "io.frees" %% "frees-rpc-prometheus-server" % "0.13.2"
libraryDependencies += "io.frees" %% "frees-rpc-prometheus-client" % "0.13.2"

// optional - for both server and client metrics reporting, using Dropwizard.
libraryDependencies += "io.frees" %% "frees-rpc-dropwizard-server" % "0.13.2"
libraryDependencies += "io.frees" %% "frees-rpc-dropwizard-client" % "0.13.2"

// optional - for the communication between server and client by using SSL/TLS.
libraryDependencies += "io.frees" %% "frees-rpc-netty-ssl" % "0.13.2"
```

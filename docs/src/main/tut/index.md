...
The current version for [mu] is "0.18.0" using the following common libraries and versions.
...
libraryDependencies += "io.higherkindness" %% "mu-rpc-server" % "0.18.0"
...
libraryDependencies += "io.higherkindness" %% "mu-rpc-monix" % "0.18.0"
// or:
libraryDependencies += "io.higherkindness" %% "mu-rpc-fs2" % "0.18.0"

// required for the use of the derived RPC client/s, using either Netty or OkHttp as transport layer:
libraryDependencies += "io.higherkindness" %% "mu-rpc-netty" % "0.18.0"
// or:
libraryDependencies += "io.higherkindness" %% "mu-rpc-okhttp" % "0.18.0"
...
libraryDependencies += "io.higherkindness" %% "mu-rpc-marshallers-jodatime" % "0.18.0"

// optional - for using the client cache.
libraryDependencies += "io.higherkindness" %% "mu-rpc-client-cache" % "0.18.0"
```

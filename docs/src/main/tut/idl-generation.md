...
However, as we said in [the previous section](generate-sources-from-idl.md), the easiest and reliable way to use the plugin is integrating the source generation in your compile process by adding this import to your `build.sbt` file:

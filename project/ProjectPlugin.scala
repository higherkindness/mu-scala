...
object ProjectPlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val V = new {
      ...
      val catsEffect: String            = "2.3.3"
      val circe: String                 = "0.13.0"
      val dockerItScala                 = "0.9.9"
      val dropwizard: String            = "4.1.18"
      val embeddedKafka: String         = "2.7.0"
      val enumeratum: String            = "1.6.1"
      val fs2: String                   = "2.5.3"
      val fs2Grpc: String               = "0.9.0"
      val fs2Kafka: String              = "1.4.1"
      ...
      val scalaCollectionCompat: String = "2.4.1"

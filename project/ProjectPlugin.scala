...
object ProjectPlugin extends AutoPlugin {
  ...
  object autoImport {
    ...
    lazy val V = new {
      ...
      val catsEffect: String            = "3.4.10"
      val catsRetry: String             = "3.1.0"
      val dockerItScala                 = "0.11.0"
      val dropwizard: String            = "4.2.18"
      val enumeratum: String            = "1.7.2"
      val fs2: String                   = "3.6.1"
      val fs2Grpc: String               = "2.5.12"
      val grpc: String                  = "1.54.0"
      ...
      val pureconfig: String            = "0.17.3"
      val scalaCollectionCompat: String = "2.10.0"

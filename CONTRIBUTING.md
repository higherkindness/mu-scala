...
Discussion around mu-rpc happens in the [Gitter channel](https://gitter.im/47deg/mu) as well as on
...
People are expected to follow the [Typelevel Code of Conduct](http://typelevel.org/conduct.html) when discussing mu-rpc on the Github page, Gitter channel, or other venues.
...
mu-rpc follows a standard [fork and pull](https://help.github.com/articles/using-pull-requests/) model for contributions via GitHub pull requests.

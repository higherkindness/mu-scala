...
import freestyle.free.rpc.Utils.database.a4
import freestyle.free.asyncCatsEffect.implicits._
import freestyle.free.rpc.client._
import freestyle.free.rpc.protocol._
import freestyle.free.rpc.server._
...
object Utils {
  ...
  object handlers {
    ...
    object client {
      ...
      import freestyle.free.rpc.Utils.clientProgram.MyRPCClient
      import service._
  ...
  trait FreesRuntime {
    ...
    import freestyle.free.rpc.server.handlers._
